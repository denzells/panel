...
local function CreateToggle(parent, label, defaultState, callback)
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        Animations.tw(toggleBg, .2, {BackgroundColor3=enabled and C.RED or C.MUTED})
        Animations.tw(toggleCircle, .2, {Position=enabled and UDim2.new(0,20,0.5,-7) or UDim2.new(0,2,0.5,-7)})
...
local function CreateButton(parent, label, callback)
    ...
    btn.MouseEnter:Connect(function()
        Animations.tw(btn, .1, {BackgroundColor3=Color3.fromRGB(35,35,35)})
    end)
    btn.MouseLeave:Connect(function()
        Animations.tw(btn, .1, {BackgroundColor3=Color3.fromRGB(28,28,28)})
    end)
